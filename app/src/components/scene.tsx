...
import {RED, RED_ORANGE, DEEP_SKY_BLUE, SELECTED_YELLOW, SCARLET, DUSK, WHITE, CORNFLOWER_BLUE, SAFETY_ORANGE, INLET, LPC, INTERCOOLER, COMBUSTOR_1, COMBUSTOR_2, HPT_2, HPT_1, LPT_1, LPT_2, HPC, EXHAUST, DARK_ORANGE, ELECTRIC_BLUE} from './ui/colors';
